      ...
      <div className="p-6 space-y-5 max-w-7xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-white border border-zinc-200 rounded-xl p-4">
            <p className="text-[11px] text-zinc-400 uppercase tracking-wide flex items-center">
              Total Leads
              <FormulaTooltip formula={`COUNT(all leads)\nfor selected filter`} note="Includes every status: new, active, delivered, and lost." position="bottom" />
            </p>
          ...
          <div className="bg-white border border-zinc-200 rounded-xl p-4">
            <p className="text-[11px] text-zinc-400 uppercase tracking-wide flex items-center">
              Cold Leads (7d+)
              <FormulaTooltip formula={`COUNT(active leads)\nWHERE last_activity_at\n  < today − 7 days`} note="Active = not delivered/lost. Value shown = SUM of their deal_value." position="bottom" />
            </p>
          ...
          <div className="bg-rose-50 border border-rose-200 rounded-xl p-4">
            <p className="text-[11px] text-rose-400 uppercase tracking-wide flex items-center">
              Urgent (14d+)
              <FormulaTooltip formula={`COUNT(active leads)\nWHERE last_activity_at\n  < today − 14 days`} note="Subset of cold leads. 14+ days = high risk of losing to a competitor." position="bottom" />
            </p>
          ...
          <div className="bg-white border border-zinc-200 rounded-xl p-4">
            <p className="text-[11px] text-zinc-400 uppercase tracking-wide flex items-center">
              Top Lost Reason
              <FormulaTooltip formula={`MODE(lost_reason)\nFROM leads WHERE\n  status = "lost"`} note="The most common reason recorded when a lead was marked as lost." position="left" />
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white border border-zinc-200 rounded-xl p-5">
              <h3 className="text-sm font-semibold text-zinc-900 mb-1 flex items-center">
                Stage Breakdown
                <FormulaTooltip formula={`stageCount ÷ totalLeads × 100`} note="% of all leads that ever reached this stage. First stage = 100%; each stage shows relative reach." position="right" />
              </h3>
              ...
              <div className="mt-4 p-3 bg-zinc-50 rounded-lg">
                <p className="text-xs text-zinc-500 flex items-center flex-wrap gap-1">
                  <span className="font-semibold text-zinc-700 flex items-center">
                    {data.funnel[0]?.count
                      ...
                      : 0}
                    %
                    <FormulaTooltip formula={`deliveredCount ÷ newLeadsCount × 100`} note="End-to-end conversion: how many of the leads that entered the pipeline were ultimately delivered." position="right" />
                  </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white border border-zinc-200 rounded-xl p-5">
              <h3 className="text-sm font-semibold text-zinc-900 mb-4 flex items-center">
                Breakdown
                <FormulaTooltip formula={`reasonCount ÷ totalLost × 100`} note="Percentage of all lost leads attributed to each reason. Requires lost_reason to be recorded." position="right" />
              </h3>
              <div className="space-y-3">
          ...
          <div className="bg-white border border-zinc-200 rounded-xl overflow-hidden">
            <div className="px-5 py-4 border-b border-zinc-100">
              <h3 className="text-sm font-semibold text-zinc-900 flex items-center">
                ...
                <FormulaTooltip formula={`convRate = deliveredFromSource\n  ÷ totalFromSource × 100`} note="Conv% = how many leads from this channel were ultimately delivered. Bar shows total leads (light) vs. delivered (dark)." position="right" />
              </h3>
