      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-1.5">
          <span className="text-[11px] text-zinc-400 flex items-center">
            Monthly Target
            <FormulaTooltip formula={`attainment =\n  actualUnits ÷ targetUnits\n  × 100`} note="Green ≥ 90%, amber ≥ 60%, red below 60%. Target is set per-branch per-month." position="right" />
          </span>
      ...
      <div className="grid grid-cols-3 gap-2 pt-3 border-t border-zinc-50">
        <div>
          <p className="text-[10px] text-zinc-400 uppercase tracking-wide flex items-center">
            Leads
            <FormulaTooltip formula={`COUNT(all leads)\nfor this branch\n(all statuses)`} note="Total leads ever assigned to this branch — includes active, delivered, and lost." position="right" />
          </p>
        ...
        <div>
          <p className="text-[10px] text-zinc-400 uppercase tracking-wide flex items-center">
            Delivered
            <FormulaTooltip formula={`COUNT(leads)\nWHERE status\n  = "delivered"`} note="Leads that were handed over to the customer (deal closed)." position="right" />
          </p>
        ...
        <div>
          <p className="text-[10px] text-zinc-400 uppercase tracking-wide flex items-center">
            Revenue
            <FormulaTooltip formula={`SUM(deal_value)\nWHERE status\n  = "delivered"`} note="Total revenue from all delivered leads at this branch." position="left" />
          </p>
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="bg-zinc-50 border-b border-zinc-100">
                    <th className="px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400">Name</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400">Role</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400">Leads</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400">Delivered</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400">Revenue</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-400">
                      Conv %
                      <FormulaTooltip formula={`delivered ÷ totalLeads × 100`} note="Of all leads assigned to this rep, how many were delivered." position="left" />
                    </th>
                  </tr>
                </thead>
