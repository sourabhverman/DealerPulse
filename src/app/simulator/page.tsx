      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-2.5">
          <div className="relative group">
            <div className={cn("w-8 h-8 rounded-lg flex items-center justify-center cursor-help", color)}>
              <Icon size={14} className="text-white" />
            </div>
            {/* Formula tooltip */}
            <div className="absolute left-10 top-1/2 -translate-y-1/2 z-50 hidden group-hover:block w-64 bg-zinc-900 text-white rounded-xl shadow-xl p-3 pointer-events-none">
              <p className="text-[10px] font-semibold uppercase tracking-wider text-zinc-400 mb-1.5">Formula</p>
              <p className="text-xs font-mono leading-relaxed text-zinc-100 whitespace-pre-line">{formula}</p>
              <div className="absolute left-[-5px] top-1/2 -translate-y-1/2 w-2.5 h-2.5 bg-zinc-900 rotate-45" />
            </div>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <SliderCard
              ...
              formula={`Units = coldLeads × (recovery% ÷ 100) × 40%\nRevenue = Units × avgDealSize\n\n40% = assumed close probability\nfor re-engaged mid-funnel leads`}
            ...
            <SliderCard
              ...
              formula={`Units = tdLeads × Δrate × negRate × orderRate\n\nΔrate = boost ÷ 100\nnegRate = current neg→order rate\norderRate = current order→delivered rate\nRevenue = Units × avgDealSize`}
            ...
            <SliderCard
              ...
              formula={`Units = negLeads × Δrate × orderRate\n\nΔrate = boost ÷ 100\norderRate = current order→delivered rate\nRevenue = Units × avgDealSize`}
            ...
            <SliderCard
              ...
              formula={`Revenue = totalUnits × newAvgDeal − totalUnits × currentAvgDeal\n\nnewAvgDeal = currentAvgDeal × (1 + uplift% ÷ 100)\ntotalUnits = delivered + new units from other levers`}
